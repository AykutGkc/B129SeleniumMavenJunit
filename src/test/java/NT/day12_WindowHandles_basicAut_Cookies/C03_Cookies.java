...
public class C03_Cookies extends TestBase {
     ...
     */
        ...
        //    2-tum cookie’leri listeleyin
        //Tüm cookie'leri listeleyebilmek icin driver.manage().getCookies() methodunu kullaniriz
     ...
     /*   for (Cookie w : cookieSet) {
        ...
        //    5-ismi “en sevdigim cookie” ve degeri “cikolatali” olan bir cookie  olusturun ve sayfaya ekleyin
        Cookie cookie=new Cookie("En sevdigim Cookie","Cikolata");
        ...
        //    7-ismi skin olan cookie’yi silin ve silindigini test edin
        int silinmedenÖnce=driver.manage().getCookies().size();
        driver.manage().deleteCookieNamed("skin");
        int sildiktensonra=driver.manage().getCookies().size();
        Assert.assertEquals(1,(silinmedenÖnce-sildiktensonra));
